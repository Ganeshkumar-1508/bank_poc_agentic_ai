                                ...
                                if len(result.tasks_output) >= 5:
                                    ...
                                    if not df.empty:
                                        ...
                                        with col1:
                                            ...
                                            rate_option = {
                                                "title": {"text": "General vs Senior Interest Rates", "left": "center"},
                                                "tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}},
                                                "legend": {"bottom": 0},
                                                "grid": {"left": "3%", "right": "4%", "bottom": "15%", "containLabel": True},
                                                "xAxis": {"type": "category", "data": df["Provider"].tolist()},
                                                "yAxis": {"type": "value", "name": "Interest Rate (%)"},
                                                "series": [
                                                    {
                                                        "name": "General Rate (%)",
                                                        "type": "bar",
                                                        "data": df["General Rate (%)"].tolist(),
                                                        "itemStyle": {"color": "#7197D4"},
                                                    },
                                                    {
                                                        "name": "Senior Rate (%)",
                                                        "type": "bar",
                                                        "data": df["Senior Rate (%)"].tolist(),
                                                        "itemStyle": {"color": "#1E3A8A"},
                                                    },
                                                ],
                                            }
                                            st_echarts(options=rate_option, height="400px", key="echarts_rate_comparison")

                                        # Chart 2: Maturity Amounts
                                        with col2:
                                            st.markdown("### Maturity Amounts by Provider")
                                            mat_option = {
                                                "title": {"text": "General vs Senior Maturity Amounts", "left": "center"},
                                                "tooltip": {"trigger": "axis", "axisPointer": {"type": "shadow"}},
                                                "legend": {"bottom": 0},
                                                "grid": {"left": "3%", "right": "4%", "bottom": "15%", "containLabel": True},
                                                "xAxis": {"type": "category", "data": df["Provider"].tolist()},
                                                "yAxis": {"type": "value", "name": "Maturity Amount", "axisLabel": {"formatter": "{value}"}},
                                                "series": [
                                                    {
                                                        "name": "General Maturity",
                                                        "type": "bar",
                                                        "data": df["General Maturity"].tolist(),
                                                        "itemStyle": {"color": "#7FACF5"},
                                                    },
                                                    {
                                                        "name": "Senior Maturity",
                                                        "type": "bar",
                                                        "data": df["Senior Maturity"].tolist(),
                                                        "itemStyle": {"color": "#1E3A8A"},
                                                    },
                                                ],
                                            }
                                            st_echarts(options=mat_option, height="400px", key="echarts_maturity_comparison")
                                        # --- END REPLACEMENT ---
...
with tab2:
    if st.session_state.last_analysis_data is None:
        ...
        if True:
            ...
            # --- 2. MAIN GROWTH TRAJECTORY CHART (Altair kept for complex interactions) ---
                ...
                for bank in tickers:
                    ...
                    chart1 = (
                        ...
                        .encode(
                            ...
                            color=alt.Color(
                                "Series:N",
                                scale=alt.Scale(domain=["Bank", "Peer Average"], range=["#EF4444", "#94A3B8"]),
