...
def get_llm():
    return NVIDIA(model="meta/llama-3.1-405b-instruct") #meta/llama-3.1-405b-instruct, meta/llama-3.1-70b-instruct, nvidia/nemotron-3-nano-30b-a3b, qwen/qwen3-next-80b-a3b-instruct

def get_llm_2():
    return NVIDIA(model="meta/llama-3.1-405b-instruct")

langchain_ddg_tool = DuckDuckGoSearchRun()

@tool("DuckDuckGo Search")
def search_ddg(query: str) -> str:
    """
    Search DuckDuckGo for information. 
    Use this tool to find current financial rates, news, and provider details.
    """
    return langchain_ddg_tool.invoke(query)
